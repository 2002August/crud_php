                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                id="txt_nombres"
                                class="form-control"
                                placeholder="Ejemplo: Nombre1 Nombre 2"
                                aria-describedby="helpId"
                            />
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="lbl_puestos" class="form-label">Puesto</label>
                            <select
                    ...
                    >
                        ...
                        <tbody id="tbl_empleados" class="table-group-divider">
                            <tr>
                                ...
                                include("datos_conexion.php");
                                $db_conexion = mysqli_connect($db_host, $db_usr, $db_pass, $db_nombre);
                                $db_conexion ->real_query("select e.id_empleado as id, e.codigo, e.nombres,e.apellidos,e.apellidos,e.direccion, e.telefono,e.fecha_nacimiento, p.puesto, p.id_puesto from empleados e inner join puestos p on e.id_puesto = p.id_puesto;");
                                $resultado = $db_conexion->use_result();
